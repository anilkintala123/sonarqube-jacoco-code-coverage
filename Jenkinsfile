...
pipeline {
  ...
  environment{
    ...
    //def PROJECT_URL = "https://github.com/anilkintala123/code-examples-for-gradle-jacoco.git"
    //def PROJECT_URL = "https://github.com/anilkintala123/gradle-jacoco.git"
    def PROJECT_URL = "https://github.com/anilkintala123/sonarqube-jacoco-code-coverage.git"
